...
public class HutangAutocompleteCustomAdapter extends BaseAdapter implements Filterable {

	private Context context;
	ArrayList<HutangObject> list;
	ArrayList<HutangObject> listTemp;
	HutangFilter filter;
	private int layoutId;
	
	public HutangAutocompleteCustomAdapter(Context context, ArrayList<HutangObject> list, int layoutId) {
		super();
		this.context = context;
		this.list = list;
		this.listTemp = list;
		this.filter = new HutangFilter();
	...
	public long getItemId(int position) {
		return list.get(position).id_hutang;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		nominal.setText(customFormat.format(list.get(position).jumlah_hutang));
	...
	private class HutangFilter extends Filter {
		...
		public CharSequence convertResultToString(Object resultValue) {			
			String str = ((HutangObject)(resultValue)).nama; 
            return str;
		}
		...
		protected FilterResults performFiltering(CharSequence constraint) {
			...
			ArrayList<HutangObject> listResult = new ArrayList<HutangObject>();											
		...
		protected void publishResults(CharSequence constraint,
			...
			list = (ArrayList<HutangObject>)results.values;

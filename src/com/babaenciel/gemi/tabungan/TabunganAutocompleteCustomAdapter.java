...
public class TabunganAutocompleteCustomAdapter extends BaseAdapter implements Filterable {

	private Context context;
	ArrayList<TabunganObject> list;
	ArrayList<TabunganObject> listTemp;
	TabunganFilter filter;
	private int layoutId;
	
	public TabunganAutocompleteCustomAdapter(Context context, ArrayList<TabunganObject> list, int layoutId) {
		super();
		this.context = context;
		this.list = list;
		this.listTemp = list;
		this.filter = new TabunganFilter();
	...
	public long getItemId(int position) {
		return list.get(position).id_tabungan;
	}
	...
	private class TabunganFilter extends Filter {
		
		@Override
		public CharSequence convertResultToString(Object resultValue) {			
			String str = ((TabunganObject)(resultValue)).nama; 
            return str;
		}
		...
		protected FilterResults performFiltering(CharSequence constraint) {
			...
			ArrayList<TabunganObject> listResult = new ArrayList<TabunganObject>();											
		...
		protected void publishResults(CharSequence constraint,
			...
			list = (ArrayList<TabunganObject>)results.values;

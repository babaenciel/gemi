...
public class AnggaranPengeluaranInsertFormFromWidgetActivity extends SherlockActivity {
	...
	AnggaranPengeluaranInsertFormFromWidgetActivity activity = this;
	int id_baru;
	int id_anggaran;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor cursor = db.getAnggaranNamaAll(myDate.getTanggalUtuh());
	    ...
	    button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {				
				...
				if(nama.getText() == null || nominal.getText() == null || tanggal.getText() == null) {
					Toast.makeText(context, "semua kolom harus terisi", Toast.LENGTH_LONG);
				}else {
